...
bool Graphics::InitializeScene()
{
	try
	{
		...
		//Initialize model(s)
		if (!this->cube.Initialize(this->device.Get(), this->deviceContext.Get(), this->pavementTexture.Get(), this->cb_vs_vertexshader))
		{
			ErrorLogger::Log("Failed to initialize cube model.");
			return false;
		}
