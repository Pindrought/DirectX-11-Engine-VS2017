...
bool Graphics::InitializeScene()
{
	try
	{
		...
		if (!gameObject.Initialize("Data\\Objects\\Samples\\blue_cube_notexture.fbx", this->device.Get(), this->deviceContext.Get(), this->grassTexture.Get(), this->cb_vs_vertexshader))
			return false;
